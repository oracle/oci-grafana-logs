...
for binary in \
  oci-logs-plugin_darwin_amd64 \
  oci-logs-plugin_darwin_arm64 \
  oci-logs-plugin_linux_amd64 \
  oci-logs-plugin_linux_arm \
  oci-logs-plugin_linux_arm64 \
  oci-logs-plugin_windows_amd64.exe; do
